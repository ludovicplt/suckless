...
static const char *upvolume[]	= { "/usr/bin/pactl", "set-sink-volume", "0", "+5%",	NULL };
static const char *downvolume[]	= { "/usr/bin/pactl", "set-sink-volume", "0", "-5%",	NULL };
static const char *mutevolume[]	= { "/usr/bin/pactl", "set-sink-mute",   "0", "toogle",	NULL };
